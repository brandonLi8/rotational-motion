...
define( require => {
  ...
  class VisibilityCheckbox extends FlexBox {
     ...
     * @param {string} [label] - the label Text of the VisibilityCheckbox, placed to the right of the Checkbox
    ...
    constructor( visibilityProperty, label, icon, options ) {
      assert( !label || typeof label === 'string', `invalid label: ${ label }` );
      ...
      if ( label ) children.push( new Text( label, RotationalMotionConstants.PANEL_TEXT_OPTIONS ) );
